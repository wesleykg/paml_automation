...
cml = codeml.Codeml()
cml.working_dir = os.path.join(working_dir, "m1")
...
lnL = results["NSsites"][1]["lnL"] # Stores the log-likelihood value
results_filename = os.path.join(working_dir, "lnL_m1_" + gene_name + ".txt") # Stores the results_filename
